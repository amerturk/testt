...
namespace WhiteMvvm
{
    public class WhiteApplication : Application
    {
        ...
        /// <returns></returns>
        public static void SetHomePage<TViewModel>(object parameter = null, bool isNavigationPage = true)
        {
        ...
        public static void SetHomePage(IList<PageContainer> pageContainers, TabbedPage tabbedPage = null, bool hasNavBar = false)
        {
            _resolve = BaseLocator.Instance.Resolve<IReflectionResolve>();
        ...
        public static void SetHomePage(PageContainer master, PageContainer detail, MasterDetailPage masterDetailPage = null, bool hasNavBar = false)
        {
            _resolve = BaseLocator.Instance.Resolve<IReflectionResolve>();
            ...
            masterViewModel.InitializeAsync(master.Parameter);
            detailViewModel.InitializeAsync(detail.Parameter);
        }
